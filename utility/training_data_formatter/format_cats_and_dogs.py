...
if __name__ == "__main__":
    ...
    random_labels = [
        ...
        "This is an image of an animal, which is a ",
        "What a beautiful looking ",
    ]

    data["text"] = data["label"].apply(lambda x: random.choice(random_labels) + x)
    ...
    data.to_csv(save_dir + "/cats_dogs_csv.csv", index=False)
