...
if __name__ == "__main__":
    ...
    random_labels = [
        "This is a {}, which is a musical instrument",
        "The image is of a {}",
        "The instrument played in this image is of a {}",
    ]

    data["text"] = data["label"].apply(lambda x: random.choice(random_labels).format(x))
    ...
    data.to_csv(save_dir + "/musical_instrument_csv.csv", index=False)
