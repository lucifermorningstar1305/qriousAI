...
if __name__ == "__main__":
    ...
    random_label = [
        "The flower in this picture is a {}",
        "This is an image of a {}",
        "The flower in this image is a {}",
    ]
    data["text"] = data["label"].apply(lambda x: random.choice(random_label).format(x))
    data = data.sample(n=8000, random_state=32)
    ...
    data.to_csv(save_dir + "/flower_csv.csv", index=False)
