...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        type=float,
        default=0.2,
        help="the size of the test dataset",
    )
    ...
    val_data, test_data = train_test_split(dummy_data, test_size=0.5, shuffle=False)
    ...
    final_merged_df.columns = ["image_id", "text", "image_path", "data_use_for"]
